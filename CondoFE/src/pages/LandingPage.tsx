...
const LandingPage: React.FC<{ token: string }> = ({ token }) => {
  ...
  <ul style={{ listStyle: 'none', padding: 0, marginTop: 60 }}>
          ...
          {canViewModule(userRoles, 'categorias-expensas') && (
            <li>
              <Link
          ...
          {canViewModule(userRoles, 'expensas-servicio') && (
            <li>
              <Link
          ...
          {canViewModule(userRoles, 'pagos-servicio') && (
            <li>
              <Link
                to="/pagos-servicio"
          ...
          {canViewModule(userRoles, 'tipos-servicio') && (
            <li>
              <Link
                to="/tipos-servicio"
          ...
          {canViewModule(userRoles, 'tipo-propiedades') && (
            <li>
              <Link
                to="/tipo-propiedades"
          ...
          {canViewModule(userRoles, 'usuario') && (
            <li>
              <Link
                to="/usuario"
          ...
          {canViewModule(userRoles, 'usuarios') && (
            <li>
              <Link
                to="/usuarios"
          ...
          {canViewModule(userRoles, 'duenos-propiedades') && (
            <li>
              <Link
